...
def main():
    ...
    print("⏱️  ВНИМАНИЕ: Новый парсер заходит в каждую карточку!")
    print("🕐 Процесс может занять 5-15 минут (зависит от количества объявлений)")
    print("🖼️  Будут загружены до 10 фотографий в высоком качестве")
    print("📝 Будут получены полные описания из карточек")
    print("=" * 50)

    # Создаем парсер (НЕ headless = показываем браузер, max_images = 10)
